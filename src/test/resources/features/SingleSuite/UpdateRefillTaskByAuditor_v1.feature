Feature: Verify the functionality of Update Refill Task by Refiller from v1 endpoint
  ...
  @Excel
  Scenario: Update all the Refill Task by Auditor from v1 endpoint
    And Give the Excel file to get the request payload for updating Refill task "QuickFill_TestData.xlsx"
    And Give the sheet name "UpdateRefillTasksByAuditor" to get all the Refill Task to be updated
  ...
  @URTR
  Scenario: Update Refill Task by Refill Auditor with refilledQuantity similar to requestedQuantity from v1 endpoint
    And Get the refillId to update refill task from v1 endpoint
    And Give the status to update the refill task "VERIFIED" from v1 endpoint
    And Provide the refilled quantity for updating refill task 15 from v1 endpoint
    And Give the comments for updating refill task by auditor from v1 endpoint "checking the update refill task functionality"
...
#  @URTR
  Scenario: Update Refill Task by Refill Auditor with refilledQuantity less than requestedQuantity from v1 endpoint
    And Get the refillId to update refill task from v1 endpoint
...
#  @URTR
  Scenario: Update Refill Task by Refill Auditor without refillID from v1 endpoint
    And Give the status to update the refill task "COMPLETED" from v1 endpoint
    And Provide the refilled quantity for updating refill task 15 from v1 endpoint
    And Give the comments for updating refill task by auditor from v1 endpoint "checking the update refill task functionality"
    When Requester calls the Update Refill Task's v1 endpoint to update refill task
...
#  @URTR
  Scenario: Update Refill Task by Refill Auditor without status from v1 endpoint
    And Get the refillId to update refill task from v1 endpoint
    And Provide the refilled quantity for updating refill task 15 from v1 endpoint
    And Give the comments for updating refill task by auditor from v1 endpoint "checking the update refill task functionality"
    When Requester calls the Update Refill Task's v1 endpoint to update refill task
...
#  @URTR
  Scenario: Update Refill Task by Refill Auditor without refilledQuantity field from v1 endpoint
    And Get the refillId to update refill task from v1 endpoint
    And Give the status to update the refill task "VERIFIED" from v1 endpoint
    And Give the comments for updating refill task by auditor from v1 endpoint "checking the update refill task functionality"
    When Requester calls the Update Refill Task's v1 endpoint to update refill task
...
#  @URTR
  Scenario: Update Refill Task by Refill Auditor with refilledQuantity more than requestedQuantity from v1 endpoint
    And Get the refillId to update refill task from v1 endpoint
    And Give the status to update the refill task "VERIFIED" from v1 endpoint
...
#  @URTR
  Scenario Outline: Update Refill Task by Refill Auditor with invalid refillId from v1 endpoint
...
#  @URTR
  Scenario Outline: Update Refill Task by Refill Auditor with invalid status from v1 endpoint
    And Get the refillId to update refill task from v1 endpoint
...
#  @URTR
  Scenario: Update Refill Task by Refill Auditor of other siteID from v1 endpoint
    And Get the refillId to update refill task from v1 endpoint
    And Give the status to update the refill task "VERIFIED" from v1 endpoint
    And Provide the refilled quantity for updating refill task 15 from v1 endpoint
    And Give the comments for updating refill task by auditor from v1 endpoint "checking the update refill task functionality"
...
#  @URTR
  Scenario: Update Refill Task by Refill Auditor Requester from v1 endpoint
    And Get the refillId to update refill task from v1 endpoint
    And Give the status to update the refill task "VERIFIED" from v1 endpoint
    And Provide the refilled quantity for updating refill task 15 from v1 endpoint
    And Give the comments for updating refill task by auditor from v1 endpoint "checking the update refill task functionality"
