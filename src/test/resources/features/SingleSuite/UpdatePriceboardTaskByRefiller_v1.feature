Feature: Verify the functionality of Update Refill Task by Refiller
  ...
  @Excel
  Scenario: Update all the Priceboard Task by Refiller from v1 endpoint
    And Give the Excel file to get the request payload for updating Priceboad task "QuickFill_TestData.xlsx"
    And Give the sheet name "UpdatePriceboardTasksByRefiller" to get all the Priceboard Task to be updated
  ...
  @UPTR
  Scenario: Update Priceboard Task by Refiller with valid data from v1 endpoint
    And Get the refillId to update priceboard task from v1 endpoint
    And Give the status to update the priceboard task from v1 endpoint "COMPLETED"
    ...
    And Give the comments for updating priceboard task from v1 endpoint "checking the update priceboard task functionality"
...
#  @UPTR
  Scenario: Update Priceboard Task partially by Refiller from v1 endpoint
    And Get the refillId to update priceboard task from v1 endpoint
    And Give the status to update the priceboard task from v1 endpoint "COMPLETED"
    And Provide the priceboards to be updated from v1 endpoint
      | priceBoard                        | pbStatus |
...
#  @UPTR
  Scenario: Update Priceboard Task by Refiller without refillID from v1 endpoint
    And Give the status to update the priceboard task from v1 endpoint "COMPLETED"
    And Provide the priceboards to be updated from v1 endpoint
      | priceBoard                        | pbStatus |
      | A4/1 - Full page price board      | true     |
...
#  @UPTR
  Scenario: Update Priceboard Task by Refiller without status from v1 endpoint
    And Get the refillId to update priceboard task from v1 endpoint
    And Provide the priceboards to be updated from v1 endpoint
      | priceBoard                        | pbStatus |
      | A4/1 - Full page price board      | true     |
...
#  @UPTR
  Scenario: Update Priceboard Task by Refiller without priceBoards field from v1 endpoint
    And Get the refillId to update priceboard task from v1 endpoint
    And Give the status to update the priceboard task from v1 endpoint "COMPLETED"
    And Give the comments for updating priceboard task from v1 endpoint "checking the update priceboard task functionality"
    When Requester calls the Update Priceboard Task v1 endpoint to update priceboard task
...
#  @UPTR
  Scenario: Update Priceboard Task by Refiller with priceBoards field as null from v1 endpoint
    And Get the refillId to update priceboard task from v1 endpoint
    And Give the status to update the priceboard task from v1 endpoint "COMPLETED"
...
#  @UPTR
  Scenario: Update Priceboard Task by Refiller without priceBoard and pbStatus field from v1 endpoint
    And Get the refillId to update priceboard task from v1 endpoint
    And Give the status to update the priceboard task from v1 endpoint "COMPLETED"
...
#  @UPTR
  Scenario: Update Priceboard Task by Refiller with only priceBoard in priceBoards field from v1 endpoint
    And Get the refillId to update priceboard task from v1 endpoint
    And Give the status to update the priceboard task from v1 endpoint "COMPLETED"
    And Provide the priceboards to be updated from v1 endpoint
      | priceBoard                        |
...
#  @UPTR
  Scenario: Update Priceboard Task by Refiller with only pbStatus in priceBoards field from v1 endpoint
    And Get the refillId to update priceboard task from v1 endpoint
    And Give the status to update the priceboard task from v1 endpoint "COMPLETED"
    And Provide the priceboards to be updated from v1 endpoint
      | pbStatus |
...
#  @UPTR
  Scenario Outline: Update Priceboard Task by Refiller with invalid refillId from v1 endpoint
...
#  @UPTR
  Scenario Outline: Update Priceboard Task by Refiller with invalid status from v1 endpoint
    And Get the refillId to update priceboard task
...
#  @UPTR
  Scenario: Update Priceboard Task by Refiller of other siteID from v1 endpoint
    And Get the refillId to update priceboard task from v1 endpoint
    And Give the status to update the priceboard task from v1 endpoint "COMPLETED"
    And Provide the priceboards to be updated from v1 endpoint
      | priceBoard                        | pbStatus |
...
#  @UPTR
  Scenario: Update Priceboard Task by Refill Requester from v1 endpoint
    And Get the refillId to update priceboard task from v1 endpoint
    And Give the status to update the priceboard task from v1 endpoint "COMPLETED"
    And Provide the priceboards to be updated from v1 endpoint
      | priceBoard                        | pbStatus |
